...
var tutorial_data = [{
  ...
  "data": [{
    ...
    "correct": "That's right! This one has both steam and whitish smoke (in this middle). Whitish smoke may look like steam and can be hard to identify. One way to distinguish them is that smoke can slowly fade away with lower opacities, while steam fades away immediately.",
  ...
  "data": [{
    ...
    "correct": "Nice! This one shows only steam.",
