...
var tutorial_data = [{
  ...
  "data": [{
    ...
    "wrong": "Oops! This one has both steam and whitish smoke, which needs to be selected. Whitish smoke may look like steam and can be hard to identify. One way to distinguish them is that smoke can slowly fade away with low opacities, while steam fades away immediately.",
    "label": 1,
    ...
    "correct": "Nice! This one shows mainly steam and should not be selected. Steam disappears faster and has sharp edges when compared to smoke. Steam also has extremely high opacity, which makes its background not visible.",
  ...
  "data": [{
    ...
    "correct": "Good job! This one has bad weather. During bad weather, it is almost impossible to know if the video has smoke.",
  ...
  "data": [{
    ...
    "correct": "Nice! This one has high-opacity smoke.",
    ...
    "correct": "Nice! This one shows cloud shadows and some steam.",
  ...
  "data": [{
    ...
    "correct": "That's right! This one shows mainly steam.",
    "wrong": "Oops! This one shows mainly steam, which should be ignored.",
    ...
    "correct": "Good job! This one shows cloud shadows and some steam.",
    "wrong": "Oops! This one shows cloud shadows and some steam (no smoke), which should be ignored.",
    ...
    "wrong": "Oops! This one shows only steam, which should be ignored. The dark steam may be caused by the cloud shadow.",
